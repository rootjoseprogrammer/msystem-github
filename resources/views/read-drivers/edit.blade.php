		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					Modificar Unidad Lectora
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6 col-lg-offset-3">
                            {!! Form::open(['route' => ['read-drivers.update', $read->id], 'method' => 'PUT', 'role' => 'form', 'id' => 'FormReadEdit']) !!}
                            {{ method_field('PUT') }}
                                ...
                                <div class="form-group {{ $errors->has('speed') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('speed', $read->speed, ['class' => 'form-control', 'required', 'autofocus']) !!}
