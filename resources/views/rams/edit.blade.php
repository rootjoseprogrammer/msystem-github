                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6 col-lg-offset-3">
                            {!! Form::open(['route' => ['rams.update', $ram->id], 'method' => 'PUT', 'role' => 'form', 'id' => 'FormRamAdd']) !!}
                            {{ method_field('PUT') }}
                                ...
                                <div class="form-group {{ $errors->has('type') ? ' has-error' : '' }}">
                                    {!! Form::label('Tipo de RAM') !!}
                                    {!! Form::text('type', $ram->type, ['class' => 'form-control', 'required', 'autofocus']) !!}
                                ...
                                <div class="form-group {{ $errors->has('speed') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('speed', $ram->speed, ['class' => 'form-control', 'required', 'autofocus']) !!}
                                ...
                                <div class="form-group {{ $errors->has('capacity') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('capacity', $ram->capacity, ['class' => 'form-control', 'required', 'autofocus']) !!}
