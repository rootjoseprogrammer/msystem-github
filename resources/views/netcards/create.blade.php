...
@section('content')
	...
	<div class="row">
		<div class="col-lg-12">
            <h1 class="page-header">Registrar Tarjetas de Red</h1>
        </div>
	</div>
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					Registro de Tarjeta de Red
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6 col-lg-offset-3">
                            {!! Form::open(['route' => 'netcards.store', 'method' => 'POST', 'role' => 'form', 'id' => 'FormNetCardAdd']) !!}
                                ...
                                <div class="form-group {{ $errors->has('type_slot') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('type_slot', null, ['class' => 'form-control', 'required', 'autofocus']) !!}
